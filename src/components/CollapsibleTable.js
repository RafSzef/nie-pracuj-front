                            ...
                            <Table size="small" aria-label="purchases">
                                ...
                                <TableBody>
                                    ...
                                    <TableRow>
                                        ...
                                        <TableCell align="right">{row.technology.name} {row.seniority.name}</TableCell>
...
export default function CollapsibleTable() {
    ...
    const url = 'http://localhost:8080/adv/all';

    const getDataPost = async () => {
        await axios.post('http://localhost:8080/adv/create',
            createData("TestPost", 2000, 3000))
            .then((response) => {
    ...
    function createData(name, salaryFrom, salaryTo) {
        return {
            name,
            salaryFrom,
            salaryTo
